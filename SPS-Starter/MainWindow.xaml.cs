...
namespace SPS_Starter
{
    public class AlleEigenschaften
    {
        ...
        public AlleEigenschaften(string Kurzbezeichnung, string GruppenName, string KnopfBeschriftung, WebBrowser BrowserBezeichnung, StackPanel StackPanelBezeichnung, Button ButtonBezeichnung)
        {
    ...
    public partial class MainWindow : Window
    {
        ...
        string DummyString = "";
        string LeereHtmlSeite = "<!doctype html> Leere Seite?  </html >";
        string HtmlSeite = "";
        ...
        {
            Eigenschaften_Logo8.Add(new AlleEigenschaften("PLC", "Logo8", "Logo Projekt starten", Web_Logo8_PLC, StackPanel_Logo8_PLC, Button_Starten_Logo8_PLC));
            Eigenschaften_Logo8.Add(new AlleEigenschaften("BUG", "Logo8", "Logo Projekt starten", Web_Logo8_PLC_Bugs, StackPanel_Logo8_PLC_Bugs, Button_Starten_Logo8_PLC_Bugs));

            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC, StackPanel_TiaPortal_PLC, Button_Starten_TiaPortal_PLC));
            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC_DT", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC_DT, StackPanel_TiaPortal_PLC_DT, Button_Starten_TiaPortal_PLC_DT));
            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC_HMI", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC_HMI, StackPanel_TiaPortal_PLC_HMI, Button_Starten_TiaPortal_PLC_HMI));
            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC_FIO", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC_FIO, StackPanel_TiaPortal_PLC_FIO, Button_Starten_TiaPortal_PLC_FIO));
            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC_BUG", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC_Bugs, StackPanel_TiaPortal_PLC_Bugs, Button_Starten_TiaPortal_PLC_Bugs));
            Eigenschaften_TiaPortal.Add(new AlleEigenschaften("PLC_Snap7", "TIA_PORTAL_V14_SP1", "TiaPortal Projekt starten", Web_TiaPortal_PLC_Snap7, StackPanel_TiaPortal_PLC_Snap7, Button_Starten_TiaPortal_PLC_Snap7));

            Eigenschaften_TwinCAT.Add(new AlleEigenschaften("PLC", "TwinCAT", "TwinCAT Projekt starten", Web_TwinCAT_PLC, StackPanel_TwinCAT_PLC, Button_Starten_TwinCAT_PLC));
            Eigenschaften_TwinCAT.Add(new AlleEigenschaften("PLC_DT", "TwinCAT", "TwinCAT Projekt starten", Web_TwinCAT_PLC_DT, StackPanel_TwinCAT_PLC_DT, Button_Starten_TwinCAT_PLC_DT));
            Eigenschaften_TwinCAT.Add(new AlleEigenschaften("PLC_VISU", "TwinCAT", "TwinCAT Projekt starten", Web_TwinCAT_PLC_VISU, StackPanel_TwinCAT_PLC_VISU, Button_Starten_TwinCAT_PLC_VISU));
            Eigenschaften_TwinCAT.Add(new AlleEigenschaften("PLC_NC", "TwinCAT", "TwinCAT Projekt starten", Web_TwinCAT_PLC_NC, StackPanel_TwinCAT_PLC_NC, Button_Starten_TwinCAT_PLC_NC));
            Eigenschaften_TwinCAT.Add(new AlleEigenschaften("PLC_BUG", "TwinCAT", "TwinCAT Projekt starten", Web_TwinCAT_PLC_Bugs, StackPanel_TwinCAT_PLC_Bugs, Button_Starten_TwinCAT_PLC_Bugs));
